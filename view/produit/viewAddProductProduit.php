                ...
                <div class="header-left-bottom agileinfo">
                    <form action="index.php?controller=produit&action=storeProduct" method="post"  enctype="multipart/form-data" >
                        ...
                        <div class="icon1">
                            ...
                            <input type="text" placeholder="Titre du voyage .." id="titre" name="titre"  required="required" pattern="[A-Za-z0-9./*-+=#\_@]" >
                        </div>
                        <label style="color: white;">Description : </label>
                        <div class="icon1">
                            <i class="fa" aria-hidden="true"></i>
                            <textarea type="text"  id="desc" name="desc" placeholder="Entrer votre description ici ... "></textarea>
                        </div>
                        <label style="color: white;">Prix :</label>
                        <div class="icon1">
                            <i class="fa" aria-hidden="true"></i>
                            <input type="text" placeholder="Entrer le prix du voyage" id="prix" name="prix" required="required" pattern="[0-9.,]+" >
                        </div>
                        ...
                        <div class="icon1">
                            ...
                            <select id="pays" required name="pays" style="height: 50px;">
                                <option style="color: black;" selected value="Pays">--Pays--</option>
                                <?php
